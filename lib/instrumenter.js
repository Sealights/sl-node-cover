    ...
    Instrumenter.prototype = {
        ...
        ifBranchInjector: function (node, walker) {
            var alreadyIgnoring = !!this.currentState.ignoring,
                ...
                child;
            this.coverState.fnToBranch[this.currentState.func].push([this.currentState.branch, 0]);
            this.coverState.fnToBranch[this.currentState.func].push([this.currentState.branch, 1]);
        ...
        switchBranchInjector: function (node, walker) {
            ...
            for (i = 0; i < cases.length; i += 1) {
                ...
                this.coverState.fnToBranch[this.currentState.func].push([this.currentState.branch, i]);
            }
        },
