...
(function (isNode) {
    ...
    function readSourceMaps(fullFilename){
        ...
        try {
            ...
            console.error('Ignoring invalid source map: '+sourceMapsFilename);
            return null;
        }
        ...
        try {
            ...
            console.error('Error processing source maps for file: '+sourceMapsFilename);
            return null;
        }
    }
                ...
                if (this.sourceMaps) {
                    try {
                        ...
                        if (originalPosition && originalPosition.source && originalPosition.line!==null && originalPosition.column!==null) {
                            ...
                            if (originalFilename.indexOf("webpack:/webpack/")===-1) {//Ignore Embedded resource that has no corresponding source
