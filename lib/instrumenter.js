...
(function (isNode) {
    ...
    function defaultWalker(node, walker) {
        ...
        if (node.type == SYNTAX.FunctionDeclaration.name || node.type == SYNTAX.FunctionExpression.name) {
            ...
            if (childNode && !childNode.skipWalk) {
                ...
                if (isArray(childNode)) {
                    ...
                    for (j = 0; j < childNode.length; j += 1) {
                        ...
                        pathElement.index = j;
                        if (childElement) {
                            if (childElement.type !== SYNTAX.FunctionDeclaration.name && childElement.type !== SYNTAX.FunctionExpression.name) {
                    ...
                    if (childNode.type !== SYNTAX.FunctionDeclaration.name && childNode.type !== SYNTAX.FunctionExpression.name) {
