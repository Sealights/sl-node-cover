...
(function (isNode) {
    ...
    function Instrumenter(options) {
        ...
        this.instrumentError = "$$slInstrumentError$$";
    ...
    Instrumenter.prototype = {
        ...
        instrumentSync: function (code, filename, metadata) {
            ...
            var program;
            metadata = metadata || {};
            metadata.sourceMaps = metadata.sourceMaps==undefined ? true : !!metadata.sourceMaps;
            var sourceMaps = metadata.sourceMaps && readSourceMaps(filename);
        ...
        getPreamble: function (sourceCode, emitUseStrict) {
            ...
            code = preambleHeader.concat([
                ...
                .replace(/%GLOBAL%/g, replacer(this.instrumentError))
